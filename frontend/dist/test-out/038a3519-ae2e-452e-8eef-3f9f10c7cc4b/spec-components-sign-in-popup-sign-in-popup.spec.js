...
var init_testing2 = __esm({
  "node_modules/@angular/common/fesm2022/http/testing.mjs"() {
    ...
    HttpClientTestingBackend = class _HttpClientTestingBackend {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: _HttpClientTestingBackend, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: _HttpClientTestingBackend });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: HttpClientTestingBackend, decorators: [{
      type: Injectable
    }] });
    HttpClientTestingModule = class _HttpClientTestingModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: _HttpClientTestingModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.15", ngImport: core_exports, type: _HttpClientTestingModule, imports: [HttpClientModule] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: _HttpClientTestingModule, providers: [provideHttpClientTesting()], imports: [HttpClientModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: core_exports, type: HttpClientTestingModule, decorators: [{
      type: NgModule,
      args: [{
...
// src/components/sign-in-popup/sign-in-popup.spec.ts
var require_sign_in_popup_spec = __commonJS({
  "src/components/sign-in-popup/sign-in-popup.spec.ts"(exports) {
    init_layout();
    init_testing2();
    init_testing();
    init_esm();
...
export default require_sign_in_popup_spec();
...
@angular/common/fesm2022/http/testing.mjs:
   ...
   *)
*/
//# sourceMappingURL=spec-components-sign-in-popup-sign-in-popup.spec.js.map
